...
|----------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|
| *exchange_segment*   | Allowed values (exact match only, aliases not in this list are rejected): `nse_cm`, `NSE`, `nse`; `bse_cm`, `BSE`, `bse`; `nse_fo`, `NFO`, `nfo`; `bse_fo`, `BFO`, `bfo`; `bcs-fo`, `BCD`, `bcd`; `mcx_fo` (no `MCX`/`mcx` alias accepted). Currency derivatives (`CDS`/`cds`/`cde_fo`) are **not** accepted.                                                                                                                                                                                                                                                               | Str            |
