...
# This creates:
# - dist/kotakneoapi-2.1.0-py3-none-any.whl (wheel)
# - dist/kotakneoapi-2.1.0.tar.gz (source)
```
...
tar -tzf dist/kotakneoapi-2.1.0.tar.gz | head -20

# Check wheel contents
unzip -l dist/kotakneoapi-2.1.0-py3-none-any.whl | head -20
```
...
# Install from wheel
pip install dist/kotakneoapi-2.1.0-py3-none-any.whl
