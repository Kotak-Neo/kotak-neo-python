...
[![PyPI Version](https://img.shields.io/badge/pypi-v2.2.7-green.svg)](https://pypi.org/project/kotakneoapi/)
...
**Upgrading:**
- **[Migration Guide (v2.0.2 → v2.2.7)](https://github.com/Kotak-Neo/kotak-neo-python/blob/main/docs/guides/MIGRATION.md)** - Upgrade existing code to the latest version
